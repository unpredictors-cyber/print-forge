            ...
            {column.newsletter ? (
              <div className="mt-3 max-w-xs">
                ...
                <form className="mt-4 flex" onSubmit={(event) => event.preventDefault()}>
                  ...
                  <input id="footer-newsletter" type="email" placeholder="Email address" className="min-w-0 flex-1 rounded-l-md border border-background/20 bg-background/10 px-3 py-2 text-sm text-background outline-none placeholder:text-background/50 focus:border-background/60" />
