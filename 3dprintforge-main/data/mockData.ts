...
export const mockProducts: Product[] = [
  {
    ...
    price: 34,
    images: ['/images/products/desk-organizer.png'],
  ...
  },
  {
    ...
    price: 28,
    images: ['/images/products/voronoi-planter.png'],
  ...
  },
  {
    ...
    price: 24,
    images: ['/images/products/articulated-dragon.png'],
  ...
  },
  {
    ...
    price: 16,
    images: ['/images/products/phone-stand.png'],
  ...
  },
  {
    ...
    price: 52,
    images: ['/images/products/hex-shelves.png'],
...
export const mockReviews: Review[] = [
  {
    ...
    rating: 5,
    comment:
      'The print quality is outstanding — layer lines are barely visible. Fits my whole desk setup perfectly.',
    created_at: '2026-07-14T10:22:00Z',
  },
  {
    id: 'rev-2',
    product_id: 'prod-desk-organizer',
    ...
    user_name: 'Daniel K.',
    rating: 4,
    comment: 'Solid and well designed. Wish the card tray were slightly deeper, but overall great.',
    created_at: '2026-07-02T15:40:00Z',
  },
  {
    id: 'rev-3',
    ...
    user_name: 'Sofia L.',
    rating: 5,
    comment: 'Bought as a gift and it was a huge hit. Every joint moves smoothly right out of the box.',
  ...
  },
  {
    ...
    user_name: 'Maya R.',
    rating: 5,
    comment: 'Gorgeous piece. My succulents have never looked better and drainage works great.',
    created_at: '2026-07-20T18:12:00Z',
  },
  {
    id: 'rev-5',
    ...
    user_name: 'Ahmed B.',
    rating: 4,
    comment: 'The weighted pieces feel premium. Resin finish is worth the upgrade.',
    created_at: '2026-07-25T12:30:00Z',
  },
  {
    id: 'rev-6',
    product_id: 'prod-phone-stand',
    user_id: 'user-3',
    user_name: 'Daniel K.',
    rating: 5,
    comment: 'Simple, sturdy, perfect angle for video calls. Shipped faster than promised.',
    created_at: '2026-08-01T08:45:00Z',
  },
  {
    id: 'rev-7',
    product_id: 'prod-litho-lamp',
    user_id: 'user-4',
    user_name: 'Sofia L.',
    rating: 5,
    comment: 'Sent a photo of my grandparents and the result made my mom cry. Incredible keepsake.',
