    ...
    <section aria-label="Customer reviews" className="mt-14">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <div ref={panelRef} className="relative">
          <button type="button" onClick={openReviewForm} className="rounded-md bg-secondary px-4 py-2 text-sm font-medium text-secondary-foreground transition hover:bg-secondary/80">Write a review</button>
